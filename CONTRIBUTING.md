How to contribute to Cozy Konnector Free?
=========================================
...
- What is the version of the Cozy Konnector Free?
...
```
$ git clone github.com/cozy/cozy-konnector-free.git
$ cd <SLUG_GH>
$ git remote add fork git://github.com/yourusername/cozy-konnector-free.git
```
...
Go to https://github.com/yourusername/cozy-konnector-free and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Cozy Konnector Free is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/cozy-konnector-free/issues/new
...
[localization]: https://github.com/cozy/cozy-konnector-free/blob/master/README.md#localization
